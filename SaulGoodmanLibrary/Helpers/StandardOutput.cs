...
{
    public static DiscordEmbedBuilder Success(string message) => new DiscordEmbedBuilder()
        .WithAuthor("Success", "", ImageHelper.Images["Success"])
        .WithDescription(message)
        .WithThumbnail(ImageHelper.Images["SmilingGus"])
        .WithColor(DiscordColor.Green);

    public static DiscordEmbedBuilder Error(string message) => new DiscordEmbedBuilder()
