...
public class Dice(DiceTypes type)
{
    public int RollOnce() => DiceInfo[Type][RandomHelper.RNG.Next(DiceInfo[Type].Count)];
    ...
    public int GetRollTotal(List<int> rolls) => rolls.Sum();
